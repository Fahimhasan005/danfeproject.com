...
<!-- header section ends -->
<div class="heading" style="background:url(images/topics.jpg) no-repeat">
   <!-- <h1>packages</h1> -->
</div>
...
<section class="packages">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="content">
            <!-- <h3>food menu</h3> -->
            <!-- <p>Unique & delicious south asian food menu!</p> -->
      ...
      <div class="box">
         ...
         <div class="content">
            <!-- <h3>Chef</h3> -->
            <!-- <p>Professional chef are preparing nan!</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <!-- <h3>Elementary student</h3> -->
            <!-- <p>Elementary students of Nepal are showing their creativity skills !</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <!-- <h3>ESD</h3> -->
            <!-- <p>Outstanding activites with ESD & Danfe project !</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            ...
            <!-- <p>Exchange cultural festival Nepal community in Okayama!</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <!-- <h3>Danfe product</h3> -->
            <!-- <p>Danfe own branded coffee,tea etc which are imported from Nepal are in the exhibition !</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <!-- <h3>Danfe product</h3> -->
            <!-- <p>Danfe products in a stall of exihibition !</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            ...
            <p>Cultural exchange with Nepal community organised by Danfe!</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            ...
            <p>Adventure & tour of Terakoya students in Nepal!</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <!-- <h3>Kids sports activity</h3>
            <p>Sports activity of Terakoya students in Nepal!</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <!-- <h3>Kids extra curriculum activities</h3>
            <p>Kids extra curriculum activities of Terakoya students in Nepal !</p> -->
            <!-- <a href="book.php" class="btn">book now</a> -->
         </div>
      </div>
   ...
   <div class="load-more"><span class="btn">詳しくはこちら</span></div>
